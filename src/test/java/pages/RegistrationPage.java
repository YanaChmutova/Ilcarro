...
public class RegistrationPage extends BasePage{
    @FindBy(xpath = "//label[contains(text(),'Name')]") // Эта строка использует аннотацию @FindBy для поиска
    ...
    @FindBy(xpath = "//label[contains(text(),'Email')]]") //Эта строка использует аннотацию @FindBy для поиска
    // веб-элемента на веб-странице с помощью XPath-выражения. В данном случае, элемент найден по XPath,
